 ...
 * Description: Utilize GitHub to alter a mileage calculator file
 */
...
public class Lab09 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		cmb1.getItems().addAll(defaultResult, altResult);
	...
	private void changeLabels() {
		...
		String selectedValue = cmb1.getValue();
		if (selectedValue.equals(altResult) && lblCapacity.getText().equals(defaultCapacity)) {
			// update labels
	...
	private void calcMileage() {
		...
		double result = 0.0;
		String selectedValue = cmb1.getValue();
		if (selectedValue.equals(altResult)) {
			// liters / 100KM
